...
public class MysqlIO {
    ...
    /**
     * Re-authenticates as the given users and password
     * 
     * @param userName
     * @param password
     * @param database
    ...
    void doHandshake(String user, String password, String database) throws SQLException {
        ...
        if ((versionMeetsMinimum(4, 1, 0) || ((this.protocolVersion > 9) && (this.serverCapabilities & CLIENT_RESERVED) != 0))) {
            if ((versionMeetsMinimum(4, 1, 1) || ((this.protocolVersion > 9) && (this.serverCapabilities & CLIENT_PROTOCOL_41) != 0))) {
                ...
                // We allow the users to configure whether
     ...
     * given database as a given MySQL users. This can happen upon initial
     ...
     * 
     * @param user
     *            the MySQL users account to log into
     * @param password
     *            authentication data for the users account (depends
        ...
        while (0 < counter--) {
            ...
            if (!done) {
                ...
                if (challenge != null) {
                    ...
                    // We allow the users to configure whether or not they want to support multiple queries (by default, this is disabled).
                    if (this.connection.getAllowMultiQueries()) {
                        this.clientParam |= CLIENT_MULTI_STATEMENTS;
                    }
                    ...
                    if (plugin == null) {
                         ...
                         * successfully. If default is 'sha256_password' then the authentication will fail as expected. In both cases users's password won't be
