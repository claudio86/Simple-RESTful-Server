...
public interface AuthenticationPlugin extends Extension {
     ...
     * call. Values of users and password parameters are passed from
     * those in MysqlIO.changeUser(String userName, String password,
     * String database) or MysqlIO.doHandshake(String users, String
     ...
     * saves users and password into connection only after successful
     * handshake.
     * 
     * @param user
     * @param password
