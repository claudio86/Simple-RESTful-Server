 ...
 * 
 * StatementInterceptors are "chainable" when configured by the users, the results returned by the "current" interceptor will be passed on to the next on in the
 * chain, from left-to-right order, as specified by the users in the JDBC configuration property "statementInterceptors".
 */
