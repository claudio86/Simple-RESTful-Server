 ...
 * 
 * <p>
 * When a Driver class is loaded, it should create an instance of itself and register it with the DriverManager. This means that a users can load and register a
...
public class NonRegisteringDriver implements java.sql.Driver {
     ...
     * passed to the driver.
     */
    public static final String USER_PROPERTY_KEY = "users";
